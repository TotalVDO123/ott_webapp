...
export function registerEndpoints(app: Express) {
  app.get('/internal/healthcheck', (req: Request, res: Response, next: NextFunction) => {
  ...
  app.post('/v2/sites/:site_id/billing-portal', (req: Request, res: Response, next: NextFunction) =>
